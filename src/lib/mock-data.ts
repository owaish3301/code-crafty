        ...
        subtopics: [
          {
            ...
            description: "Understanding JavaScript variables and primitive types",
          },
      ...
      },
      {
        ...
        subtopics: [
          ...
          { id: "1-5-3", title: "Context API", description: "Using React Context for simpler state management" },
          {
            ...
            description: "Optimizing state management for performance",
          },
        ],
      },
    ],
        ...
        subtopics: [
          {
            ...
            description: "Basic JavaScript syntax, data types, and variables",
          },
...
export function getAllRoadmaps(): { id: string; name: string; description: string }[] {
  const baseRoadmaps = Object.entries(mockRoadmaps).map(([, roadmap]) => ({
    id: roadmap.id,
    name: roadmap.name,
    description: roadmap.description,
  }))

  // Add some additional roadmaps for the admin interface
  return [
    ...baseRoadmaps,
    {
      id: "6",
      name: "DevOps Engineer",
      description: "Learn DevOps practices, CI/CD, and cloud infrastructure",
    },
    {
      id: "7",
      name: "Data Science",
